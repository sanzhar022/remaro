...
export async function AccountHeaderButton() {
  ...
  const className = "flex min-h-11 min-w-11 max-w-24 flex-col items-center justify-center gap-0.5 rounded-[var(--radius-md)] px-2 text-[11px] text-white/75 transition-colors hover:bg-white/10 hover:text-primary focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-primary/40";
  return (<>
